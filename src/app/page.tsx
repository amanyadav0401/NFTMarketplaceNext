...
async function MarketPlacePage() {
  ...
  let brands: any = []
  try {
    const data = await fetch(`https://prod-api.nft-world.one/items/live/marketplace`, { cache: 'no-store' })
    const brandData = await fetch(`https://prod-api.nft-world.one/auth/brands`, { cache: 'no-store' })
