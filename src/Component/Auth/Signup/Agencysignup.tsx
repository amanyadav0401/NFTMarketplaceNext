  ...
  return (
    <div className="bg-[#3F2D6D] min-h-screen flex justify-center items-center overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-5 md:max-w-8xl">
        ...
        <div className="bg-[#52427c] items-center h-auto md:min-h-[90vh] rounded-xl flex justify-center flex-shrink-0 max-w-2xl ml-5 mr-5">
        ...
        <div className="p-4 mt-5">
          ...
          <h1 className="text-white font-bold text-2xl mt-5 mb-4">
            <span className="text-[#E377FF]">SignUp</span> to Partner Account
          </h1>
          <InputField
            label="Username"
            type="text"
          ...
          <div className="mt-[2rem]">
            <p className="text-[14px] text-white text-center">
              ...
              <Link href={"/auth/login/agency"} passHref>
